...
public class Star08 {
	...
	/*
	 * method를 정의할때 같은 class 내부내에서는 원칙적으로
	 * 변수와 같이 같은 이름의 method를 정의(선언)할 수 없다.
	 * 
	 * 하지만 Java에서는(Java의 특징중 1가지로)
	 * 매개변수의 개수가 다르면 같은 이름의 method를 정의 할 수 있다.=> 중복정의(over Loading) 가능 이라고한다
	 * 
	 */
